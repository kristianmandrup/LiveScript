...
function detect-livescript-es filename
  # See if directive "use harmony" can be found at top of file
  is-harmony-file = file-contains filename, /^("use harmony"|'use harmony');?\s*\n/

  say "is-harmony-file", is-harmony-file
  if is-harmony-file then LiveScriptEs6 else LiveScript
