...
(function(){
  ...
  function detectDirective(source){
    /("use harmony"|'use harmony')/.test(source);
  }
  function detectLivescriptEs(filename){
    var hasHarmonyDirective;
    hasHarmonyDirective = fshoot('readFile', source, function(){
      detectDirective(source);
    });
    if (hasHarmonyDirective != null) {
      LiveScriptES6;
    } else {
      LiveScript;
    }
